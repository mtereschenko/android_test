...
public class BluetoothService extends Service {
    ...
    private static String MAC_ADDRESS = "YOUR:MAC:ADDRESS:HERE";
    ...
    public int onStartCommand (Intent intent, int flags, int startId) {
        bluetoothIn = new Handler() {
            ...
            public void handleMessage (android.os.Message msg) {
                ...
                Log.d("DEBUG", "handleMessage" + readMessage);
...
//                recDataString.delete(0, recDataString.length());                    //clear all string data
        ...
        Log.d("BT SERVICE", "SERVICE STARTED" + intent.getStringExtra("command"));
        if (command != null && mConnectedThread != null) {
            mConnectedThread.write(command);
        }
        Log.d("DEBUG", "handleMessage23423423423");
...
//                mConnectedThread.write("rainbow/10");
            } catch (IOException e) {
                try {
